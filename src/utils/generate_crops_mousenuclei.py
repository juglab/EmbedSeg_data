...
def process(tup):
    ...
    image_path='/media/manan/Samsung_T5/Manan/Data/ISBI/MouseNuclei_original/crops-1/test/images/' #TODO change this to crops-0
    instance_path='/media/manan/Samsung_T5/Manan/Data/ISBI/MouseNuclei_original/crops-1/test/masks/' #TODO
