...
def process(tup):
    im, inst = tup
    image_path='/media/manan/Samsung_T5/Manan/Data/ISBI/Usiigaci512x512_original/crops-0/trainVal/images/' #TODO change this to crops-0
    instance_path='/media/manan/Samsung_T5/Manan/Data/ISBI/Usiigaci512x512_original/crops-0/trainVal/masks/' #TODO
...
if __name__ == '__main__':
    ...
    IMAGE_DIR=os.path.join(DATA_DIR, 'train/images/')##TODO
    INSTANCE_DIR=os.path.join(DATA_DIR, 'train/masks/')##TODO
    print(IMAGE_DIR)
    OBJ_ID = 0
    CROP_SIZE=512 #TODO: 512
