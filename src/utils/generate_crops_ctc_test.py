...
def process(tup):
    im, inst = tup
    image_path='/media/manan/Samsung_T5/Manan/Data/ISBI/CTC_original/crops-1/test/images/' #TODO change this to crops-0
    instance_path='/media/manan/Samsung_T5/Manan/Data/ISBI/CTC_original/crops-1/test/masks/' #TODO
